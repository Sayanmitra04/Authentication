...
import { useNavigate } from "react-router-dom"; // Added useNavigate for routing
import { AppContent } from "../context/AppContext"; // Added AppContent
...
const EmailVerify = () => {
  ...
  const { backendurl ,isLoggedin,userData,getUserdata} = useContext(AppContent); // Added backendurl
